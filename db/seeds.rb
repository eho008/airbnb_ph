...
rollercoaster2 = Rollercoaster.create!(id: 2, user: User.find(2), name: "Russian roulette", location: "56A Shoreditch High St, London", price: 140, description: "Who's going to survive this ride?")
...
rollercoaster3 = Rollercoaster.create!(id: 3, user: User.find(3), name: "Nice and easy", location: "Jardin Anglaise, Paris", price: 210, description: "A great family-friendly ride for all ages")
...
rollercoaster4 = Rollercoaster.create!(id: 4, user: User.find(4), name: "Halloween street", location: "9th av, create! York", price: 250, description: "Trick or ride. Better not to eat much beforehand 🤭")
...
rollercoaster5 = Rollercoaster.create!(id: 5, user: User.find(5), name: "Fasten your seatbelts", location: "Red Square, Moscow", price: 120, description: "The bumpiest flight of your life. Make sure you buckle up!")
