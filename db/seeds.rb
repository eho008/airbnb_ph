...
rollercoaster4 = Rollercoaster.create!(id: 4, user: User.find(4), name: "Halloween street", location: "9th av, New York", price: 250, description: "Trick or ride. Better not to eat much beforehand 🤭")
